...
class HomeScreenCardStatusDelivering extends StatelessWidget {
  const HomeScreenCardStatusDelivering({
    super.key,
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              'Delivering',
                              maxLines: 1,
                              style: CustomTextStyles.title16GreenColorMedium.copyWith(
                                color: mainColor,
                              ),
                            ),
                          ],
